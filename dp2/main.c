...
void arraysToArray(int arrays_to_organize[maxNumberOfLists][maxCharLength], int array_to_Organize[], int stackNum){
	int i = 0;
	while(arrays_to_organize[stackNum][i] != 0){
		arrays_to_organize[i] = arrays_to_organize[stackNum][i];
	}
	return;
}
int main(int argc, char *argv[])
{
	...
	//int array_to_Organize[] = arrays_to_organize[1];
	...
	int y = (int) sizeof(arrays_to_organize);
